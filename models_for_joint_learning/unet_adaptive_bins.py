...
class DecoderBN(nn.Module):
    ...
    def forward(self, x, **kwargs):
        ...
        unet_out = self.decoder(features, **kwargs)
        ...
        pred_edge = self.edge_head(unet_out)  
    
        return bin_edges, pred_depth, pred_edge #similart to adabins forward, but now return the predicted edges in addition
